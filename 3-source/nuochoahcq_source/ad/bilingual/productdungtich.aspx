<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="productdungtich.aspx.cs" Inherits="ad_single_partner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server" Visible="false">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchProductDungTichName" runat="server" Width="200px">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                DataKeyNames="ProductDungTichID">
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="STT">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnProductDungTichID" runat="server" Value='<%# Eval("ProductDungTichID") %>' />
                            <asp:HiddenField ID="hdnProductDungTichImage" runat="server" Value='<%# Eval("ProductDungTichImage") %>' />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProductDungTichID" SortExpression="ProductDungTichID" Visible="false">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn HeaderText="Dung Tích" DataField="ProductDungTichName"
                        SortExpression="ProductDungTichName">
                        <ItemTemplate>
                            <asp:Label ID="lblProductDungTichName" runat="server" Text='<%# Eval("ProductDungTichName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Dung Tích(Tiếng Anh)" Visible="false"
                        DataField="ProductDungTichNameEn" SortExpression="ProductDungTichNameEn">
                        <ItemTemplate>
                            <asp:Label ID="lblProductDungTichNameEn" runat="server" Text='<%# Eval("ProductDungTichNameEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn DataField="ProductDungTichImage" HeaderText="Ảnh"
                        SortExpression="ProductDungTichImage" Visible="false">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ProductDungTichImage").ToString()) ? false : true %>'
                                Width="95">
                                <img alt="" src='<%# "~/res/ProductDungTich/" + Eval("ProductDungTichImage") %>' width="80"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ProductDungTichImage").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ProductDungTichID") + "#" + Eval("ProductDungTichImage") %>'
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Dung Tích</h3>
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnProductDungTichID" runat="server" Value='<%# Eval("ProductDungTichID") %>' />
                                        <asp:HiddenField ID="hdnProductDungTichImage" runat="server" Value='<%# Eval("ProductDungTichImage") %>' />
                                        <asp:RadUpload ID="FileProductDungTichImage" runat="server" ControlObjectsVisibility="None"
                                ...
                                <tr>
                                    <td class="left" valign="top">Dung Tích
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtProductDungTichName" runat="server" Text='<%# Bind("ProductDungTichName") %>'
                                ...
                                <asp:Panel ID="Panel2" runat="server" Visible="False">
                                    ...
                                    <tr>
                                        <td class="left" valign="top">Dung Tích(En)
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtProductDungTichNameEn" runat="server" Text='<%# Bind("ProductDungTichNameEn") %>'
                                                Width="500px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </asp:Panel>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            <asp:TextBoxSetting EmptyMessage="Dung Tích ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductDungTichName" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Dung Tích(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductDungTichNameEn" />
                </TargetControls>
            </asp:TextBoxSetting>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductDungTichDelete"
        SelectMethod="ProductDungTichSelectAll" TypeName="TLLib.ProductDungTich" UpdateMethod="ProductDungTichUpdate"
        InsertMethod="ProductDungTichInsert">
        <DeleteParameters>
            <asp:Parameter Name="ProductDungTichID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="ProductDungTichName" Type="String" />
            <asp:Parameter Name="ProductDungTichNameEn" Type="String" />
            <asp:Parameter Name="ConvertedProductDungTichName" Type="String" />
            <asp:Parameter Name="ProductDungTichImage" Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="Priority" Type="String" />
            <asp:Parameter Name="ProductID" Type="String" />
        </InsertParameters>
        <SelectParameters>
            <asp:ControlParameter ControlID="txtSearchProductDungTichName" Name="ProductDungTichName"
