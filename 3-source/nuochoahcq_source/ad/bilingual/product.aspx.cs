...
public partial class ad_single_product : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            string CamKet = HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtCamKet")).Content.Trim()));
            string BaoHanh = HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtBaoHanh")).Content.Trim()));
            ...
            string ProductNongDoID = ((RadComboBox)row.FindControl("ddlProductNongDo")).SelectedValue;
            string ProductMuiHuongID = ((RadComboBox)row.FindControl("ddlProductMuiHuong")).SelectedValue;
            string ProductDungTichID = ((RadComboBox)row.FindControl("ddlProductDungTich")).SelectedValue;
            string ProductPhongCachID = ((RadComboBox)row.FindControl("ddlProductPhongCach")).SelectedValue;
            string ProductHoanCanhID = ((RadComboBox)row.FindControl("ddlProductHoanCanh")).SelectedValue;
            ...
            string CamKetEn = HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtCamKetEn")).Content.Trim()));
            string BaoHanhEn = HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtBaoHanhEn")).Content.Trim()));
            ...
            if (e.CommandName == "PerformInsert")
            {
                ...
                if (!string.IsNullOrEmpty(ImageName))
                {
                    ...
                    //ResizeCropImage.ResizeByCondition(strFullPath, 185, 185);
                    ...
                    ResizeCropImage.ResizeWithBackGroundColor(strFullPath, 247, 247, bgColor);
                }
            ...
            else
            {
                ...
                dsUpdateParam["ProductNongDoID"].DefaultValue = ProductNongDoID;
                dsUpdateParam["ProductMuiHuongID"].DefaultValue = ProductMuiHuongID;
                dsUpdateParam["ProductDungTichID"].DefaultValue = ProductDungTichID;
                dsUpdateParam["ProductPhongCachID"].DefaultValue = ProductPhongCachID;
                dsUpdateParam["ProductHoanCanhID"].DefaultValue = ProductHoanCanhID;
    ...
    protected void FileImageAlbum_FileUploaded(object sender, FileUploadedEventArgs e)
    {
        ...
        ResizeCropImage.ResizeByCondition(targetFolder + newName, 400, 400);
