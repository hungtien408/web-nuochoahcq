<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="producthoancanh.aspx.cs" Inherits="ad_single_partner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server" Visible="false">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchProductHoanCanhName" runat="server" Width="200px">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                DataKeyNames="ProductHoanCanhID">
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="STT">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnProductHoanCanhID" runat="server" Value='<%# Eval("ProductHoanCanhID") %>' />
                            <asp:HiddenField ID="hdnProductHoanCanhImage" runat="server" Value='<%# Eval("ProductHoanCanhImage") %>' />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProductHoanCanhID" SortExpression="ProductHoanCanhID" Visible="false">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn HeaderText="Hoàn Cảnh Phù Hợp" DataField="ProductHoanCanhName"
                        SortExpression="ProductHoanCanhName">
                        <ItemTemplate>
                            <asp:Label ID="lblProductHoanCanhName" runat="server" Text='<%# Eval("ProductHoanCanhName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Hoàn Cảnh Phù Hợp(Tiếng Anh)"
                        DataField="ProductHoanCanhNameEn" SortExpression="ProductHoanCanhNameEn">
                        <ItemTemplate>
                            <asp:Label ID="lblProductHoanCanhNameEn" runat="server" Text='<%# Eval("ProductHoanCanhNameEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn DataField="ProductHoanCanhImage" HeaderText="Ảnh"
                        SortExpression="ProductHoanCanhImage" Visible="false">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ProductHoanCanhImage").ToString()) ? false : true %>'
                                Width="95">
                                <img alt="" src='<%# "~/res/ProductHoanCanh/" + Eval("ProductHoanCanhImage") %>' width="80"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ProductHoanCanhImage").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ProductHoanCanhID") + "#" + Eval("ProductHoanCanhImage") %>'
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Hoàn Cảnh Phù Hợp</h3>
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnProductHoanCanhID" runat="server" Value='<%# Eval("ProductHoanCanhID") %>' />
                                        <asp:HiddenField ID="hdnProductHoanCanhImage" runat="server" Value='<%# Eval("ProductHoanCanhImage") %>' />
                                        <asp:RadUpload ID="FileProductHoanCanhImage" runat="server" ControlObjectsVisibility="None"
                                ...
                                <tr>
                                    <td class="left" valign="top">Hoàn Cảnh Phù Hợp
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtProductHoanCanhName" runat="server" Text='<%# Bind("ProductHoanCanhName") %>'
                                ...
                                <asp:Panel ID="Panel2" runat="server" Visible="True">
                                    ...
                                    <tr>
                                        <td class="left" valign="top">Hoàn Cảnh Phù Hợp(En)
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtProductHoanCanhNameEn" runat="server" Text='<%# Bind("ProductHoanCanhNameEn") %>'
                                                Width="500px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </asp:Panel>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            <asp:TextBoxSetting EmptyMessage="Hoàn Cảnh Phù Hợp ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductHoanCanhName" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Hoàn Cảnh Phù Hợp(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductHoanCanhNameEn" />
                </TargetControls>
            </asp:TextBoxSetting>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductHoanCanhDelete"
        SelectMethod="ProductHoanCanhSelectAll" TypeName="TLLib.ProductHoanCanh" UpdateMethod="ProductHoanCanhUpdate"
        InsertMethod="ProductHoanCanhInsert">
        <DeleteParameters>
            <asp:Parameter Name="ProductHoanCanhID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="ProductHoanCanhName" Type="String" />
            <asp:Parameter Name="ProductHoanCanhNameEn" Type="String" />
            <asp:Parameter Name="ConvertedProductHoanCanhName" Type="String" />
            <asp:Parameter Name="ProductHoanCanhImage" Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="Priority" Type="String" />
            <asp:Parameter Name="ProductID" Type="String" />
        </InsertParameters>
        <SelectParameters>
            <asp:ControlParameter ControlID="txtSearchProductHoanCanhName" Name="ProductHoanCanhName"
