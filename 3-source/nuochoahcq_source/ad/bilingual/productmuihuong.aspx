<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="productmuihuong.aspx.cs" Inherits="ad_single_partner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server" Visible="false">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchProductMuiHuongName" runat="server" Width="200px">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                DataKeyNames="ProductMuiHuongID">
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="STT">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnProductMuiHuongID" runat="server" Value='<%# Eval("ProductMuiHuongID") %>' />
                            <asp:HiddenField ID="hdnProductMuiHuongImage" runat="server" Value='<%# Eval("ProductMuiHuongImage") %>' />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProductMuiHuongID" SortExpression="ProductMuiHuongID" Visible="false">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn HeaderText="Mùi Hương" DataField="ProductMuiHuongName"
                        SortExpression="ProductMuiHuongName">
                        <ItemTemplate>
                            <asp:Label ID="lblProductMuiHuongName" runat="server" Text='<%# Eval("ProductMuiHuongName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Mùi Hương(Tiếng Anh)"
                        DataField="ProductMuiHuongNameEn" SortExpression="ProductMuiHuongNameEn">
                        <ItemTemplate>
                            <asp:Label ID="lblProductMuiHuongNameEn" runat="server" Text='<%# Eval("ProductMuiHuongNameEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn DataField="ProductMuiHuongImage" HeaderText="Ảnh"
                        SortExpression="ProductMuiHuongImage" Visible="false">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ProductMuiHuongImage").ToString()) ? false : true %>'
                                Width="95">
                                <img alt="" src='<%# "~/res/ProductMuiHuong/" + Eval("ProductMuiHuongImage") %>' width="80"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ProductMuiHuongImage").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ProductMuiHuongID") + "#" + Eval("ProductMuiHuongImage") %>'
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Mùi Hương</h3>
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnProductMuiHuongID" runat="server" Value='<%# Eval("ProductMuiHuongID") %>' />
                                        <asp:HiddenField ID="hdnProductMuiHuongImage" runat="server" Value='<%# Eval("ProductMuiHuongImage") %>' />
                                        <asp:RadUpload ID="FileProductMuiHuongImage" runat="server" ControlObjectsVisibility="None"
                                ...
                                <tr>
                                    <td class="left" valign="top">Mùi Hương
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtProductMuiHuongName" runat="server" Text='<%# Bind("ProductMuiHuongName") %>'
                                ...
                                <asp:Panel ID="Panel2" runat="server" Visible="True">
                                    ...
                                    <tr>
                                        <td class="left" valign="top">Mùi Hương(En)
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtProductMuiHuongNameEn" runat="server" Text='<%# Bind("ProductMuiHuongNameEn") %>'
                                                Width="500px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </asp:Panel>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            <asp:TextBoxSetting EmptyMessage="Mùi Hương ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductMuiHuongName" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Mùi Hương(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductMuiHuongNameEn" />
                </TargetControls>
            </asp:TextBoxSetting>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductMuiHuongDelete"
        SelectMethod="ProductMuiHuongSelectAll" TypeName="TLLib.ProductMuiHuong" UpdateMethod="ProductMuiHuongUpdate"
        InsertMethod="ProductMuiHuongInsert">
        <DeleteParameters>
            <asp:Parameter Name="ProductMuiHuongID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="ProductMuiHuongName" Type="String" />
            <asp:Parameter Name="ProductMuiHuongNameEn" Type="String" />
            <asp:Parameter Name="ConvertedProductMuiHuongName" Type="String" />
            <asp:Parameter Name="ProductMuiHuongImage" Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="Priority" Type="String" />
            <asp:Parameter Name="ProductID" Type="String" />
        </InsertParameters>
        <SelectParameters>
            <asp:ControlParameter ControlID="txtSearchProductMuiHuongName" Name="ProductMuiHuongName"
