...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                                    ...
                                    <td valign="top">
                                                ...
                                                <table class="search">
                                                    <tr>
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 247px x 247px)</span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadComboBox Filter="Contains" ID="ddlProductNongDo" runat="server" DataSourceID="odsProductNongDo"
                                                                DataTextField="ProductNongDoName" DataValueField="ProductNongDoID" Width="504px"
                                                                OnDataBound="DropDownList_DataBound" EmptyMessage="- Chọn -">
                                                            </asp:RadComboBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadComboBox Filter="Contains" ID="ddlProductMuiHuong" runat="server" DataSourceID="odsProductMuiHuong"
                                                                DataTextField="ProductMuiHuongName" DataValueField="ProductMuiHuongID" Width="504px"
                                                                OnDataBound="DropDownList_DataBound" EmptyMessage="- Chọn -">
                                                            </asp:RadComboBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadComboBox Filter="Contains" ID="ddlProductDungTich" runat="server" DataSourceID="odsProductDungTich"
                                                                DataTextField="ProductDungTichName" DataValueField="ProductDungTichID" Width="504px"
                                                                OnDataBound="DropDownList_DataBound" EmptyMessage="- Chọn -">
                                                            </asp:RadComboBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadComboBox Filter="Contains" ID="ddlProductPhongCach" runat="server" DataSourceID="odsProductPhongCach"
                                                                DataTextField="ProductPhongCachName" DataValueField="ProductPhongCachID" Width="504px"
                                                                OnDataBound="DropDownList_DataBound" EmptyMessage="- Chọn -">
                                                            </asp:RadComboBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadComboBox Filter="Contains" ID="ddlProductHoanCanh" runat="server" DataSourceID="odsProductHoanCanh"
                                                                DataTextField="ProductHoanCanhName" DataValueField="ProductHoanCanhID" Width="504px"
                                                                OnDataBound="DropDownList_DataBound" EmptyMessage="- Chọn -">
                                                            </asp:RadComboBox>
                                                        </td>
                                                    </tr>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtProductName"
                                            Display="Dynamic" ErrorMessage="Nhập tên sản phẩm" SetFocusOnError="true">*</asp:RequiredFieldValidator>--%>
                                                    ...
                                                    <tr>
                                                        <td class="left" valign="top">Mô tả sản phẩm
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="left" valign="top">Cam kết
                                                        </td>
                                                        <td>
                                                            <asp:RadEditor ID="txtCamKet" ContentFilters="ConvertCharactersToEntities,ConvertToXhtml,OptimizeSpans,IndentHTMLContent,ConvertFontToSpan,IECleanAnchors,FixUlBoldItalic,RemoveScripts,FixEnclosingP"
                                                                runat="server" Language="vi-VN" Skin="Office2007" Width="503px" Content='<%# Bind("CamKet") %>'>
                                                                <ImageManager DeletePaths="~/Uploads/Image/" UploadPaths="~/Uploads/Image/" ViewPaths="~/Uploads/Image/"
                                                                    MaxUploadFileSize="1024000" />
                                                                <FlashManager DeletePaths="~/Uploads/Video/" UploadPaths="~/Uploads/Video/" ViewPaths="~/Uploads/Video/" />
                                                                <DocumentManager DeletePaths="~/Uploads/File/" UploadPaths="~/Uploads/File/" ViewPaths="~/Uploads/File/"
                                                    ...
                                                    <tr>
                                                        <td class="left" valign="top">Bảo hành
                                                        </td>
                                                        <td>
                                                            <asp:RadEditor ID="txtBaoHanh" ContentFilters="ConvertCharactersToEntities,ConvertToXhtml,OptimizeSpans,IndentHTMLContent,ConvertFontToSpan,IECleanAnchors,FixUlBoldItalic,RemoveScripts,FixEnclosingP"
                                                                runat="server" Language="vi-VN" Skin="Office2007" Width="503px" Content='<%# Bind("BaoHanh") %>'>
                                                                <ImageManager DeletePaths="~/Uploads/Image/" UploadPaths="~/Uploads/Image/" ViewPaths="~/Uploads/Image/"
                                                                    MaxUploadFileSize="1024000" />
                                                                <FlashManager DeletePaths="~/Uploads/Video/" UploadPaths="~/Uploads/Video/" ViewPaths="~/Uploads/Video/" />
                                                                <DocumentManager DeletePaths="~/Uploads/File/" UploadPaths="~/Uploads/File/" ViewPaths="~/Uploads/File/"
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtProductName"
                                            Display="Dynamic" ErrorMessage="Nhập tên sản phẩm" SetFocusOnError="true">*</asp:RequiredFieldValidator>--%>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:RadEditor ID="txtCamKetEn" ContentFilters="ConvertCharactersToEntities,ConvertToXhtml,OptimizeSpans,IndentHTMLContent,ConvertFontToSpan,IECleanAnchors,FixUlBoldItalic,RemoveScripts,FixEnclosingP"
                                                                    runat="server" Language="vi-VN" Skin="Office2007" Width="503px" Content='<%# Bind("CamKetEn") %>'>
                                                                    <ImageManager DeletePaths="~/Uploads/Image/" UploadPaths="~/Uploads/Image/" ViewPaths="~/Uploads/Image/"
                                                                        MaxUploadFileSize="1024000" />
                                                                    <FlashManager DeletePaths="~/Uploads/Video/" UploadPaths="~/Uploads/Video/" ViewPaths="~/Uploads/Video/" />
                                                                    <DocumentManager DeletePaths="~/Uploads/File/" UploadPaths="~/Uploads/File/" ViewPaths="~/Uploads/File/"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:RadEditor ID="txtBaoHanhEn" ContentFilters="ConvertCharactersToEntities,ConvertToXhtml,OptimizeSpans,IndentHTMLContent,ConvertFontToSpan,IECleanAnchors,FixUlBoldItalic,RemoveScripts,FixEnclosingP"
                                                                    runat="server" Language="vi-VN" Skin="Office2007" Width="503px" Content='<%# Bind("BaoHanhEn") %>'>
                                                                    <ImageManager DeletePaths="~/Uploads/Image/" UploadPaths="~/Uploads/Image/" ViewPaths="~/Uploads/Image/"
                                                                        MaxUploadFileSize="1024000" />
                                                                    <FlashManager DeletePaths="~/Uploads/Video/" UploadPaths="~/Uploads/Video/" ViewPaths="~/Uploads/Video/" />
                                                                    <DocumentManager DeletePaths="~/Uploads/File/" UploadPaths="~/Uploads/File/" ViewPaths="~/Uploads/File/"
                                        ...
                                        <div class="sub_box">
                                            ...
                                            <div class="cont">
                                                <asp:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                                    ...
                                                    <span class="required">(Kích thước 400px x 400px)</span>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductSelectAll1"
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="CamKet" Type="String" />
            ...
            <asp:Parameter Name="CamKetEn" Type="String" />
            <asp:Parameter Name="BaoHanhEn" Type="String" />
            ...
            <asp:Parameter Name="ProductMuiHuongID" Type="String" />
            <asp:Parameter Name="ProductDungTichID" Type="String" />
            <asp:Parameter Name="ProductPhongCachID" Type="String" />
            <asp:Parameter Name="ProductHoanCanhID" Type="String" />
