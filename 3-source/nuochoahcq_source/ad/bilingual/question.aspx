        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn DataField="ProductName" HeaderText="Câu Hỏi" SortExpression="ProductName" />
                    <asp:GridBoundColumn DataField="ProductNameEn" HeaderText="Câu Hỏi (En)" SortExpression="ProductNameEn" />
