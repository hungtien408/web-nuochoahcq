<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="productphongcach.aspx.cs" Inherits="ad_single_partner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server" Visible="false">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchProductPhongCachName" runat="server" Width="200px">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                DataKeyNames="ProductPhongCachID">
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="STT">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnProductPhongCachID" runat="server" Value='<%# Eval("ProductPhongCachID") %>' />
                            <asp:HiddenField ID="hdnProductPhongCachImage" runat="server" Value='<%# Eval("ProductPhongCachImage") %>' />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProductPhongCachID" SortExpression="ProductPhongCachID" Visible="false">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn HeaderText="Phong Cách" DataField="ProductPhongCachName"
                        SortExpression="ProductPhongCachName">
                        <ItemTemplate>
                            <asp:Label ID="lblProductPhongCachName" runat="server" Text='<%# Eval("ProductPhongCachName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Phong Cách(Tiếng Anh)"
                        DataField="ProductPhongCachNameEn" SortExpression="ProductPhongCachNameEn">
                        <ItemTemplate>
                            <asp:Label ID="lblProductPhongCachNameEn" runat="server" Text='<%# Eval("ProductPhongCachNameEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn DataField="ProductPhongCachImage" HeaderText="Ảnh"
                        SortExpression="ProductPhongCachImage" Visible="false">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ProductPhongCachImage").ToString()) ? false : true %>'
                                Width="95">
                                <img alt="" src='<%# "~/res/ProductPhongCach/" + Eval("ProductPhongCachImage") %>' width="80"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ProductPhongCachImage").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ProductPhongCachID") + "#" + Eval("ProductPhongCachImage") %>'
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Phong Cách</h3>
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnProductPhongCachID" runat="server" Value='<%# Eval("ProductPhongCachID") %>' />
                                        <asp:HiddenField ID="hdnProductPhongCachImage" runat="server" Value='<%# Eval("ProductPhongCachImage") %>' />
                                        <asp:RadUpload ID="FileProductPhongCachImage" runat="server" ControlObjectsVisibility="None"
                                ...
                                <tr>
                                    <td class="left" valign="top">Phong Cách
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtProductPhongCachName" runat="server" Text='<%# Bind("ProductPhongCachName") %>'
                                ...
                                <asp:Panel ID="Panel2" runat="server" Visible="True">
                                    ...
                                    <tr>
                                        <td class="left" valign="top">Phong Cách(En)
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtProductPhongCachNameEn" runat="server" Text='<%# Bind("ProductPhongCachNameEn") %>'
                                                Width="500px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </asp:Panel>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            <asp:TextBoxSetting EmptyMessage="Phong Cách ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductPhongCachName" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Phong Cách(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductPhongCachNameEn" />
                </TargetControls>
            </asp:TextBoxSetting>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductPhongCachDelete"
        SelectMethod="ProductPhongCachSelectAll" TypeName="TLLib.ProductPhongCach" UpdateMethod="ProductPhongCachUpdate"
        InsertMethod="ProductPhongCachInsert">
        <DeleteParameters>
            <asp:Parameter Name="ProductPhongCachID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="ProductPhongCachName" Type="String" />
            <asp:Parameter Name="ProductPhongCachNameEn" Type="String" />
            <asp:Parameter Name="ConvertedProductPhongCachName" Type="String" />
            <asp:Parameter Name="ProductPhongCachImage" Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="Priority" Type="String" />
            <asp:Parameter Name="ProductID" Type="String" />
        </InsertParameters>
        <SelectParameters>
            <asp:ControlParameter ControlID="txtSearchProductPhongCachName" Name="ProductPhongCachName"
