                ...
                <asp:ListView ID="lstProductDetail" runat="server" OnItemCommand="lstProductDetail_ItemCommand"
                    ...
                    <ItemTemplate>
                        <div class="dt-right">
                            ...
                            <ul>
                                <li><span>Thương hiệu</span><strong>: <%# Eval("ManufacturerName") %></strong></li>
                                <li><span>Nồng độ </span><strong>: <%# Eval("ProductNongDoName") %></strong></li>
                                <li><span>Loại nước hoa </span><strong>: <%# Eval("ProductGenderName") %></strong></li>
                                <li><span>Nhóm hương </span><strong>: <%# Eval("ProductMuiHuongName") %></strong></li>
                                <li><span>Phong cách </span><strong>: <%# Eval("ProductPhongCachName") %></strong></li>
                                <li><span>Năm phát hành </span><strong>: <%# Eval("Tag") %></strong></li>
                                <li><span>Xuất xứ </span><strong>: <%# Eval("OriginName") %></strong></li>
                            </ul>
