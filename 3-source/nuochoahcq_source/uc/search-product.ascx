        ...
        <ContentTemplate>
            <section>
                ...
                <asp:CheckBoxList ID="cblProductGender" AutoPostBack="True" DataSourceID="odsProductGender"
                    DataTextField="ProductGenderName" DataValueField="ProductGenderID" CssClass="check-search" OnDataBound="cblProductGender_DataBound"
            ...
            <section>
                ...
                <asp:CheckBoxList ID="cblProductNongDo" AutoPostBack="True" DataSourceID="odsProductNongDo"
                    DataTextField="ProductNongDoName" DataValueField="ProductNongDoID" CssClass="check-search" OnDataBound="cblProductNongDo_DataBound"
            ...
            <section>
                ...
                <asp:CheckBoxList ID="cblProductMuiHuong" AutoPostBack="True" DataSourceID="odsProductMuiHuong"
                    DataTextField="ProductMuiHuongName" DataValueField="ProductMuiHuongID" CssClass="check-search" OnDataBound="cblProductMuiHuong_DataBound"
            ...
            <section>
                ...
                <asp:CheckBoxList ID="cblProductPhongCach" AutoPostBack="True" DataSourceID="odsProductPhongCach"
                    DataTextField="ProductPhongCachName" DataValueField="ProductPhongCachID" CssClass="check-search" OnDataBound="cblProductPhongCach_DataBound"
            ...
            <section>
                ...
                <asp:CheckBoxList ID="cblProductHoanCanh" AutoPostBack="True" DataSourceID="odsProductHoanCanh"
                    DataTextField="ProductHoanCanhName" DataValueField="ProductHoanCanhID" CssClass="check-search" OnDataBound="cblProductHoanCanh_DataBound"
