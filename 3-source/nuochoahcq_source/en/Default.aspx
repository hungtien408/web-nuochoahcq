<%@ Page Title="" Language="C#" MasterPageFile="~/en/site-main.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="wrap-show">
        <section>
            ...
            <div class="read-more">
                <a href="hang-moi-ve.aspx">See all</a>
            </div>
            <div class="pro-cate">
                        ...
                        <div class="item">
                            <div class="wrap-item">
                                ...
                                <div class="it-content">
                                    ...
                                    <p><%# TLLib.Common.SplitSummary(Eval("DescriptionEn").ToString(), 100) %></p>
        ...
        <section>
            ...
            <div class="read-more">
                <a href="khuyen-mai.aspx">See all</a>
            </div>
            <div class="pro-cate">
            ...
            <ItemTemplate>
                <section>
                    <div class="id-product sp-gift">
                        <h3><%# Eval("ProductCategoryNameEn") %></h3>
                    </div>
                    <div class="read-more">
                        <a href='<%# progressTitle(Eval("ProductCategoryNameEn")) + "-pci-" + Eval("ProductCategoryID") + ".aspx" %>'>Xem tất cả</a>
                    </div>
            ...
            <ItemTemplate>
                <div class="item">
                    ...
                    <div class="news-content">
                        ...
                        <div class="news-name"><a href='<%# progressTitle(Eval("ProductNameEn")) + "-tt-" + Eval("ProductID") + ".aspx" %>'><%# Eval("ProductNameEn") %></a></div>
                        <div class="description"><%# TLLib.Common.SplitSummary(Eval("DescriptionEn").ToString(), 100) %></div>
                        <div class="view-more"><a href='<%# progressTitle(Eval("ProductNameEn")) + "-tt-" + Eval("ProductID") + ".aspx" %>'>Detail</a></div>
                    </div>
                </div>
            </ItemTemplate>
            <LayoutTemplate>
